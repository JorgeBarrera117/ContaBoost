...
let AccountsService = class AccountsService {
    ...
    async create(createAccountDto) {
        ...
        await this.pool.query('INSERT INTO accounts (id, code, name, type) VALUES (?, ?, ?, ?)', [id, createAccountDto.code, createAccountDto.name, createAccountDto.type]);
        return { id, ...createAccountDto };
    }
    async findAll() {
        const [rows] = await this.pool.query('SELECT * FROM accounts ORDER BY code ASC');
        return rows;
    }
